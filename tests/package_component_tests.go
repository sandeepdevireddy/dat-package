...
func TestCreatePackageComponents(t *testing.T) {
	...
	router.POST("/package/components", mockCreatePackage)
	...
	req, _ := http.NewRequest("POST", "/package/components", bytes.NewBuffer(requestBody))
